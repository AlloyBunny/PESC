...
class Qwen2_5_7B_Instruct():
    def __init__(self, model_name="Qwen2.5-7B-Instruct", temperature=None, lora_path=None) -> None:
        # 模型路径
        self.model_path = "/data/zhaiyuxuan/models/Qwen2.5-7B-Instruct"
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Qwen2.5-7B-Instruct模型测试")
    parser.add_argument("--lora_path", type=str, help="LoRA权重路径")
    parser.add_argument("--temperature", type=float, default=0.7, help="生成温度")
    args = parser.parse_args()
    
    model = Qwen2_5_7B_Instruct(temperature=args.temperature, lora_path=args.lora_path)
